...
class ZonaFit:
    ...
    def ejecutar_opcion(self, opcion):
        if opcion == 1:
            ...
            nom = input('Nombre del cliente a actualizar: ')
            apel = input('Apellido del cliente a actualizar: ')
            mem = input('Membresía del cliente a actualizar: ')
            cliente_a_actualizar = Cliente(p_nombre=nom, p_apellido=apel, p_membresia=mem, p_id=id)
